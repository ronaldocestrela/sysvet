...
/// <summary>
/// Refreshes tutor portal tokens via <c>/api/v1/tutor-portal/refresh</c>.
/// </summary>
public sealed class TutorAuthTokenRefresher : IAuthTokenRefresher
{
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly IAuthState _authState;

    /// <summary>Creates a refresher bound to the host DI container.</summary>
    public TutorAuthTokenRefresher(IHttpClientFactory httpClientFactory, IAuthState authState)
    {
