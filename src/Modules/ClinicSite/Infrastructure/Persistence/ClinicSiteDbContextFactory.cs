...
/// <summary>
/// Design-time factory for ClinicSite EF migrations.
/// </summary>
public sealed class ClinicSiteDbContextFactory : IDesignTimeDbContextFactory<ClinicSiteDbContext>
{
    /// <inheritdoc />
    public ClinicSiteDbContext CreateDbContext(string[] args)
    {
        ...
        var optionsBuilder = new DbContextOptionsBuilder<ClinicSiteDbContext>();
        optionsBuilder.ConfigureModuleDatabase(configuration, databaseOptions);
        return new ClinicSiteDbContext(optionsBuilder.Options, tenantContext);
    }
