...
| [`InventoryEndpointExtensions`](./InventoryEndpointExtensions.cs) | Produtos, lotes, movimentações, transferências, kardex, alertas e importação NF-e (`purchase-imports`) |
