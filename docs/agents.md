...
* `src/Modules/Intelligence/` — Dashboards operacionais do tenant, layouts por perfil, KPIs do dia via integração Sales/Petshop/Veterinary/Commerce (ADR-054; Fase 10.1).
