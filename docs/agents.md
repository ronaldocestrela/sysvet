...
* `src/Modules/Platform/` — Catálogo de tenants, onboarding/status/filiais, planos/flags, billing Asaas (Fake/Live), resolução multi-tenancy e workers (ADR-046–ADR-049; Fase 9.1–9.4).
