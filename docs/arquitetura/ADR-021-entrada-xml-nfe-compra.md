...
- **Contas a pagar (Fase 7):** após confirm, publicar `PurchaseInvoiceImportedEvent` em Core.Application; sem referência Inventory→Finance (ADR-001). Campo `ApIntegrationStatus = Pending` até consumer Finance 7.2.
