...
3. **DRE simplificada (competência operacional):** receita/despesa por `IssueDate` no mês e categoria; estornos no mês reduzem a linha da categoria. Sem CMV/impostos (7.7).
