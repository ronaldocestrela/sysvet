...
- **Caixa (7.3, ADR-033):** saldo esperado na gaveta = abertura + líquido `Cash` − sangrias + suprimentos; fechamento persiste esperado, contado e variance; movimentos via `RecordCashMovementCommand` (sync offline).
